...
function HomeComponent() {
  ...
  return (
    <div className="max-w-screen-sm p-2 text-sm">
      ...
      <p className="mb-2">This page was rendered using PPR (Partial Prerendering). It works by combining prerendered and dynamic components into a single HTTP request, eliminating initial waterfall requests for the dynamic content.</p>
      <p className="mb-2">During the build process, this route was prerendered to the fullest extent possible - the text you're reading now as well as the button is prerendered HTML.</p>
      ...
      <ol>
        ...
        <Step number={5} >Cloudflare Worker receives server rendered HTML from the lambda and streams it down to the browser</Step>
        <Step number={6} >Dynamic content gets injected to the HTML document, page repaints, and potential hydration happens</Step>
