...
import GithubLogo from '../assets/github-mark-white.svg?react'
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full text-slate-200">
      <div className="relative flex w-full">
        <a className="absolute top-0 flex h-full right-32" href='https://google.com' target='_blank'>Source<GithubLogo /></a>
